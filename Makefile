...
SRC_FILES = main.c parser_config.c error_handling.c free.c process_map.c map_validation.c cub3d.c player_position.c allocate.c config_order_validation.c flood_fill.c map_form_validation.c
